export const REPORT_STATUS = {
  ...
  approved: "approved",
  rejected: "rejected",
  creditNoteProcessing: "credit_note_processing",
  completed: "completed",
...
export type WorkflowStatus = typeof REPORT_STATUS.pendingRegional | typeof REPORT_STATUS.pendingQuality | typeof REPORT_STATUS.approved | typeof REPORT_STATUS.rejected;
...
const STORE_STATUS_LABELS: Record<ReportStatus, string> = {
  ...
  [REPORT_STATUS.creditNoteProcessing]: "Credit Note Processing",
...
export const isPendingApprovalStatus = (status: string): status is PendingApprovalStatus => status === REPORT_STATUS.pendingRegional || status === REPORT_STATUS.pendingQuality;
